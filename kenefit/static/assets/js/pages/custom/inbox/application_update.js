...
var KTAppInbox = function() {
    ...
    return {
        ...
        init: function() {
            ...
            _composeEl = KTUtil.getById('kt_inbox_update');
        ...
        initCompose: function() {
            _initEditor(_composeEl, 'kt_inbox_update_editor');
            _initAttachments('kt_inbox_update_attachments');
            _initForm('kt_inbox_update_form');
